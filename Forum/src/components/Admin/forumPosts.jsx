...
const MainForumPost = ({forumList, change, update}) => {
...
export const AdminForumPosts = ({userUpdate}) =>{
    ...
    return(
        <div>
            {hidden ? <InputPost change={()=>setHidden(false)} id={id} update={()=>postsCheck()}/> : <MainForumPost forumList={forumList} change={()=>setHidden(true)} update={()=>postsCheck()}/>}
        </div>
